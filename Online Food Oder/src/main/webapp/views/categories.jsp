...
<style>
body {
  background-image: url('https://images.pexels.com/photos/1438672/pexels-photo-1438672.jpeg?auto=compress&cs=tinysrgb&w=600');
...
<body class="bg-light">
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<div class="container-fluid">
			<a class="navbar-brand" href="#"> <img src="https://i.pinimg.com/originals/47/43/27/4743272cb7fbed0082f76c3815b3e90e.jpg"
				src="https://i.pinimg.com/originals/47/43/27/4743272cb7fbed0082f76c3815b3e90e.jpg" width="auto" height="50"
	...
	<div class="container">
		...
		<div class="modal fade" id="exampleModalCenter" tabindex="-1"
			...
			aria-hidden="true">
			<div class="modal-dialog modal-dialog-centered" role="Jain University Food Shop">
					...
					<td>
						<form action="categories/update" method="get">
							...
							<button type="button" class="btn btn-warning" data-toggle="modal"
								...
								onclick="Jain University Food Shop.getElementById('categoryname').value =  '<%=rs.getString(2)%>'; Jain University Food Shop.getElementById('categoryid').value =  '<%=rs.getString(1)%>'; ">Update
							</button>
